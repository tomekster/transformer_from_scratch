...
class FeedForwardBlock(nn.Module):
    ...
    def forward(self, x):
        # input sentence (Batch, seq_len, d_model) ---> (batch, seq_len, d_ff) ---> (batch, seq_len, d_model)
...
class MultiHeadAttentionBlock(nn.Module):
    ...
    def forward(self, q, k, v, mask):
        ...
        # (batch, seq_len, d_model) ---> (batch, seq_len, h, d_k) ---> (batch, h, seq_len, d_k)
                                                                        # We want each head to attend to the full sentence 
...
# Projecting back from embeddings to the vocab
